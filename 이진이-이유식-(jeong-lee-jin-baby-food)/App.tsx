...
const App: React.FC = () => {
  ...
  const dayCubesMade = cubes.filter(c => c.madeDate === dateStr);
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div>
              ...
              <p className="hidden sm:block text-xs font-bold text-pink-500">정이진 사랑해 ({weightPerCube}g 설정됨)</p>
            </div>
          </div>

                ...
                {fedCubes.map(meal => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                        <span className="opacity-70">{meal.fedTime}</span> {meal.ingredients[0].name}
                      </div>
                    </div>
                  );
                })}
